...
public class OrdersTopology {
  ...
  private static void orderTopology(StreamsBuilder streamsBuilder) {
    ...
    Predicate<String, Order> restaurantPredicate =
        ...
        .branch(
            ...
            Branched.withConsumer(
                generalOrdersStream -> {
                  ...
                  // SerdesFactory.revenueSerdes()));

                  aggregateOrdersByCount(generalOrdersStream, GENERAL_ORDERS_COUNT, storesTable);
                  aggregateOrdersCountByTimeWindows(
                      generalOrdersStream, GENERAL_ORDERS_COUNT_WINDOWS, storesTable);
                  aggregateOrdersByRevenue(
                      generalOrdersStream, GENERAL_ORDERS_REVENUE, storesTable);
                  aggregateOrdersRevenueByTimeWindows(
                      generalOrdersStream, GENERAL_ORDERS_REVENUE_WINDOWS, storesTable);
                }))
        .branch(
            restaurantPredicate,
            Branched.withConsumer(
...
//                          Produced.with(Serdes.String(), SerdesFactory.revenueSerdes()));
                  ...
                  aggregateOrdersByCount(
                      restaurantOrdersStream, RESTAURANT_ORDERS_COUNT, storesTable);
                  aggregateOrdersCountByTimeWindows(
                      restaurantOrdersStream, RESTAURANT_ORDERS_COUNT_WINDOWS, storesTable);
                  aggregateOrdersByRevenue(
                      restaurantOrdersStream, RESTAURANT_ORDERS_REVENUE, storesTable);
                  aggregateOrdersRevenueByTimeWindows(
                      restaurantOrdersStream, RESTAURANT_ORDERS_REVENUE_WINDOWS, storesTable);
                }));
  }

  private static void aggregateOrdersByCount(
...
//            .print(Printed.<String, TotalRevenueWithAddress>toSysOut().withLabel(storeName + "-bystore"));
  ...
  private static void aggregateOrdersByRevenue(
    ...
    Aggregator<String, Order, TotalRevenue> revenueAggregator = (key, value, aggregate) ->
  ...
  private static void aggregateOrdersRevenueByTimeWindows(
    ...
    var joinedParams =
            Joined.with(Serdes.String(), new JsonSerde<>(TotalRevenue.class), new JsonSerde<>(Store.class));
  ...
  private static void printLocalDateTimes(Windowed<String> key, Object value) {
    ...
    log.info("Start Time : {}, End Time : {}, Count : {}", startTime, endTime, value);
    ...
    log.info("Start Time : {}, End Time : {}, Count : {}", startLDT, endLDT, value);
  }
}
