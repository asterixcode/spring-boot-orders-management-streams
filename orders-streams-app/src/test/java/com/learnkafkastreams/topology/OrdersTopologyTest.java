...
class OrdersTopologyTest {
  ...
  void ordersRevenue() {
    ...
    // when
    ReadOnlyKeyValueStore<String, TotalRevenue> generalOrdersRevenue =
  ...
  void ordersRevenue_byWindows() {
    ...
    WindowStore<String, TotalRevenue> restaurantOrdersRevenue =
